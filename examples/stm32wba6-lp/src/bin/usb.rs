...
async fn main(_spawner: Spawner) {
    ...
    usb_config.manufacturer = Some("AXON");
    usb_config.product = Some("ION-COVERT");
    ...
    let bulk_rw: BulkReaderWriter<'_, Stm32UsbDriver<'_, UsbOtgHs>> =
        BulkReaderWriter::new(ep_out, ep_in);
